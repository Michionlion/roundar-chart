...
export default function Home() {
  const [code, setCode] = useState(`// Code to modify #roundar-chart and #chart-style
  ...
  return (
    <>
      ...
      <footer className={styles.footer}>
        <a href="https://github.com/Michionlion/roundar-chart" title="View on GitHub">
